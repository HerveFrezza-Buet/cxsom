...
int main(int, char**) {
  ...
  jobs_center += cxsom::jobs::make({"main", "A", 0}, {cxsom::jobs::Operation::Random, {}, {}});
  jobs_center += cxsom::jobs::make({"main", "B", 0}, {cxsom::jobs::Operation::Random, {}, {}});
  jobs_center += cxsom::jobs::make({"main", "C", 0}, {cxsom::jobs::Operation::Random, {}, {}});
  jobs_center += cxsom::jobs::make({"main", "D", 0}, {cxsom::jobs::Operation::Random, {}, {}});

  jobs_center += cxsom::jobs::make({"main", "A", 1}, {cxsom::jobs::Operation::Average, {{"main", "A", 0}, {"main", "B", 0}, {"main", "C", 0}, {"main", "D", 0}}, {}});
  jobs_center += cxsom::jobs::make({"main", "B", 1}, {cxsom::jobs::Operation::Average, {{"main", "A", 1}, {"main", "B", 1}, {"main", "C", 1}, {"main", "D", 1}}, {}});
  jobs_center += cxsom::jobs::make({"main", "C", 1}, {cxsom::jobs::Operation::Average, {{"main", "A", 1}, {"main", "B", 1}, {"main", "C", 1}, {"main", "D", 1}}, {}});
  jobs_center += cxsom::jobs::make({"main", "D", 1}, {cxsom::jobs::Operation::Average, {{"main", "A", 1}, {"main", "B", 1}, {"main", "C", 1}, {"main", "D", 1}}, {}});
