...
namespace foo {
  namespace fx {
    ...
    inline cxsom::rules::update mid_bound(cxsom::rules::kwd::data arg1,
      ...
      // The cxsom::rules::ctx variable (context) is available from previously
      // included headers.  Passing args like (*cxsom::rules::ctx)(arg) enables a
      // declaration of the argument in the cxsom context.
      return {foo_MIDBOUND_NAME, {(*cxsom::rules::ctx)(arg1), (*cxsom::rules::ctx)(arg2)}};
    }
    ...
    inline cxsom::rules::update mid_bound(cxsom::rules::kwd::data arg1,
      ...
      return {foo_MIDBOUND_NAME, {(*cxsom::rules::ctx)(arg1), (*cxsom::rules::ctx)(arg2), (*cxsom::rules::ctx)(arg3)}};
    }
	...
	for(auto& arg : args)
	  declared_args.push_back((*cxsom::rules::ctx)(arg));
